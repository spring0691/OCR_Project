...
'''
google search : RuntimeError: No CUDA GPUs are available
https://github.com/lucidrains/DALLE-pytorch/issues/111
Please remove the line

os.environ["CUDA_VISIBLE_DEVICES"] = "1"
from the beginning of the notebook, or select your GPUs there.

This works for me, I am on Windows 10 operating system with RTX 3090
'''
